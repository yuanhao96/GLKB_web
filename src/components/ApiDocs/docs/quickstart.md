...
```text
KRAS: KRAS is one of the most commonly mutated oncogenes in human cancer, driving proliferation through constitutive RAS-MAPK signaling [PMID 29695864]. Activating mutations at codon 12 are found in ~30% of all cancers [PMID 27258034].

TP53: TP53 encodes a tumor suppressor that is mutated in over 50% of human cancers, where its loss abrogates cell cycle arrest and apoptosis in response to DNA damage [PMID 28802649].
